...
function validateStep(i: number): string[] {
  ...
  e.push(...englishError({ borrowers: borrowers.value, loan: loan.value, reason: reason.value }))
  return e
}
  ...
  <div class="form-page">
    ...
    <main class="form-main">
      <SuccessScreen
        ...
        :download-href="`/api/requests/principal-reduction/${result.id}/pdf?ref=${result.reference}`"
      />
